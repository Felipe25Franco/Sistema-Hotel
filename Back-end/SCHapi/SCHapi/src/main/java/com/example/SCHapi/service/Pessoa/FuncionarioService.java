...
public class FuncionarioService {
    ...
    public void validar(Funcionario funcionario) {
        ...
        if (funcionario.getHotel() == null || funcionario.getHotel().getId() == null || funcionario.getHotel().getId() == 0 || funcionario.getHotel().getId() != funcionario.getCargo().getHotel().getId()) {
